...
SECRET_HASH_KEY = 'skdjh-il48sad;fahw4ihai84hv;aw4mvt;wa48ytmv8w4'
...
class Auth:
    ...
    async def get_current_user(self, token: str = Depends(oauth2_scheme), db: AsyncSession = Depends(database.get_db)):
